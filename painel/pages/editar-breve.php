...
<div class="box-content">
	<h2><i class="fa fa-pencil"></i> Editar Filme em Breve</h2>
		...
		<?php
			if(isset($_POST['acao'])){
				...
				if($imagem['name'] != '' && $banner['name'] != ''){
					...
					if(Painel::imagemValida($imagem) and Painel::imagemValida($banner)){
						Painel::deleteFile($imagem_atual);
						Painel::deleteFile($banner_atual);
						$imagem = Painel::uploadFile($imagem);
						$banner = Painel::uploadFile($banner);
						Breve::atualizarBreve($id,$nome,$sinopse,$diretor,$distribuidora,$elenco,$genero,$classificacao,$duracao,$data,$imagem,$banner,$trailer);
