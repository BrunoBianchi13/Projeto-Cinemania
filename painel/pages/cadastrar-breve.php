<div class="box-content">
		...
		<h2><i class="fa fa-video-camera" aria-hidden="true"></i> Cadastrar Filme Em Breve</h2>
			...
			if(isset($_POST['acao'])){
				...
				$trailer = $_POST['trailer'];
					...
					if(Painel::imagemValida($imagem) == false){
						...
						$breve->cadastrarFilme($nome,$sinopse,$diretor,$distribuidora,$elenco,$genero,$classificacao,$duracao,$data,$imagem,$banner,$trailer);
						Painel::alert('sucesso','O cadastro do  '.$nome.' foi feito com sucesso!');
					}
				}
